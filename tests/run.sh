...
test_desktop_powershell_static_checks() {
  ...
  assert_contains "$DESKTOP_PS" 'msiexec.exe' 'PowerShell setup can install Node.js MSI without winget'
  assert_contains "$DESKTOP_PS" 'MSIINSTALLPERUSER=1' 'PowerShell setup asks Node.js MSI for a user-scope install'
