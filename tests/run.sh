...
test_desktop_powershell_static_checks() {
  ...
  assert_contains "$DIAG_SERVER" 'https://raw.githubusercontent.com/OlegGorsky/w/212f701a5b808736637479028bb212b690c9fed7/Setup-CodexWindows.ps1' 'diagnostics short /i uses pinned full Codex Windows setup'
